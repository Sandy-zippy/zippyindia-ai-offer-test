  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex justify-between mt-1">
        <span className="text-xs text-[#9CA3AF]">{prefix}{min}{suffix}</span>
        <span className="text-xs text-[#9CA3AF]">{prefix}{max}{suffix}</span>
      </div>
    </div>
  )
}
...
function StatCard({
  ...
  return (
    <div className="bg-[#33333F] border border-[#3E3E48] shadow-sm rounded-2xl p-6 text-center">
      <p className="text-xs font-mono uppercase tracking-wider text-[#9CA3AF] mb-2">{sublabel}</p>
      <AnimatedCounter
        target={value}
        prefix={prefix}
        suffix={suffix}
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <ScrollReveal delay={0.1}>
            <div className="bg-[#33333F] border border-[#3E3E48] shadow-lg rounded-2xl p-6 sm:p-8">
